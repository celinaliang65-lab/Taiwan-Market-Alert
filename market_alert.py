            ...
            "contents": [
                {
                    ...
                    "contents": [
                        {"type": "text", "text": fmt_num(index_data["close"]),
                         "size": "3xl", "weight": "bold", "color": main_color},
                ...
                {"type": "filler"},
                {
                    ...
                    "contents": [
                        {"type": "text", "text": "開盤",
                         "size": "xxs", "color": "#666666", "align": "end"},
                        {"type": "text", "text": fmt_num(index_data["open"]),
                         "size": "sm", "weight": "bold", "color": "#AAAAAA",
                         "align": "end"},
                    ],
                },
            ],
